...
$('.cartbutton').click(function () {
	...
	html = ''
	for (id in cartItems) {
		html += `<tr><td><img src="https://atkhrfnsco.cloudimg.io/v7/dev.snsartsfestival.in/img/snsnartshaat/${cartItems[id].img}?w=256&h=256" class="ui image tiny"></td><td><h4>${cartItems[id].name}</h4></td></td><td><h4>₹ ${cartItems[id].price}</h4></td></tr>`
	}
